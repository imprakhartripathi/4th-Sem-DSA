...
public class Basic_Arr {
    public static void main(String[] args) { // Assignment 1 Questions
        ...
        System.out.println(" \n");
        // --------------------------------------------------------------------------------------------------------------------------------------------
        // 10 Program to rotate the elements of an array to the left or right by a given
        // number of positions.
        // --------------------------------------------------------------------------------------------------------------------------------------------
        // Q11 Program to sort elements in an array (e.g., using bubble sort, insertion
        // sort, or quicksort).
